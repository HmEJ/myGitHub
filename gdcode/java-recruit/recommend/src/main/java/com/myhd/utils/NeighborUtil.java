...
public class NeighborUtil {
    ...
    findNeighbors(long user, @Nonnull LongSet items) throws URISyntaxException {
    ...
    public Iterable<Neighbor> getCandidateNeighbors(long user, LongSet items) throws URISyntaxException {
