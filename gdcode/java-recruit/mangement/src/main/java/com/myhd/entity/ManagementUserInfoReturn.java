...
/**
 * @Classname ManagementUserInfoReturn
 * @Description
 * @Date 2024/3/30 下午7:38
 * @Created by HmEJ
 */
@Data
@AllArgsConstructor
@NoArgsConstructor
public class ManagementUserInfoReturn implements Serializable{
    private static final long serialVersionUID = -4930690891040214232L;
    /**
     * 用户编号 用于唯一识别用户
     */
